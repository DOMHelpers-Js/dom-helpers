...
**6 Independent Modules - Mix & Match:**

```html
<!-- 1. Full Bundle (34.9 KB gzipped) - Everything included -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.min.js"></script>

<!-- 2. Core Only (9.6 KB gzipped) - Standalone, smallest -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>

<!-- 3. Enhancers Only (~8.5 KB) - Requires Core first! -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.enhancers.min.js"></script>

<!-- 4. Conditions Only (~7.3 KB) - Requires Core first! -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.conditions.min.js"></script>

<!-- 5. Reactive Only (~11.9 KB) - Requires Core first! -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.reactive.min.js"></script>

<!-- 6. Native Enhance (~2 KB) - Requires Core + Enhancers first! -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.enhancers.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.native-enhance.min.js"></script>
```

**⚠️ Important:** Enhancers, Conditions, and Reactive modules require Core to be loaded first. Native Enhance requires both Core and Enhancers.
...
### Via unpkg
```html
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.min.js"></script>
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.core.min.js"></script>
```
...
**Full Bundle + Native Enhance (~36.9 KB):**
```html
<!-- Full bundle, then Native Enhance on top -->
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.native-enhance.min.js"></script>
<script>
  // Native DOM methods now return enhanced elements
  ...
  // Bulk update multiple IDs in one call
...
Load Native Enhance to make `getElementById`, `getElementsBy*`, `querySelector`, and `querySelectorAll` return fully enhanced elements automatically.

```javascript
// After loading dom-helpers.native-enhance.min.js:

// getElementById — returns an enhanced element
const btn = document.getElementById('submit-btn');
btn.update({
  textContent: 'Submit',
  disabled: false,
...
// Bulk update multiple IDs via the function itself
document.getElementById.update({
...
// Shorthand property setters
document.getElementById.textContent({ heading: 'Hello', subtext: 'World' });
document.getElementById.style({ card: { padding: '16px' }, modal: { display: 'flex' } });
document.getElementById.disabled({ submitBtn: true, cancelBtn: false });

// getElementsByClassName — returns an enhanced collection
const cards = document.getElementsByClassName('card');
cards.update({ classList: { add: 'animated' } });
cards.forEach(card => console.log(card.textContent));

// Bulk update across class names
document.getElementsByClassName.update({
  'btn-primary': { style: { backgroundColor: '#007bff' } },
  'card':        { style: { borderRadius: '8px' } }
});

// querySelectorAll — returns an enhanced NodeList
...
// querySelector — returns an enhanced element
const hero = document.querySelector('.hero-section');
hero.update({ classList: { add: 'loaded' }, style: { opacity: '1' } });
```
