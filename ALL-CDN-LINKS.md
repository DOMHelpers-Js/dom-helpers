...
| **Native Enhance** | 2.0 KB | Requires Core + Enhancers | Patches `document.getElementById`, `getElementsByClassName/TagName/Name`, `querySelector/querySelectorAll` |
...
```html
<script src="https://cdn.jsdelivr.net/npm/dom-helpers-js@2.5.2/dist/dom-helpers.storage.min.js"></script>
```
...
<!-- Storage (standalone) -->
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.storage.min.js"></script>

<!-- Enhancers (after core) -->
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.enhancers.min.js"></script>

<!-- Conditions (after core) -->
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.conditions.min.js"></script>

<!-- Reactive (after core) -->
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.reactive.min.js"></script>

<!-- Native Enhance (after core + enhancers) -->
<script src="https://unpkg.com/dom-helpers-js@2.5.2/dist/dom-helpers.native-enhance.min.js"></script>
```
